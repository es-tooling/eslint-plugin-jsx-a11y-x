...
$ pnpm run create -- rule-name --author="Your name" --description="Description of rule"
```
...
# OR
$ pnpm run create -- no-marquee --author="Ethan Cohen <@evcohen>" --description="Enforce <marquee> elements are not used."
```
