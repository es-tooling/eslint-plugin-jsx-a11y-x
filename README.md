...
| [no-interactive-element-to-noninteractive-role](docs/rules/no-interactive-element-to-noninteractive-role.md) | Disallow interactive elements being assigned non-interactive roles.                                                                 | ☑️ 🔒 |       |     |
| [no-noninteractive-element-interactions](docs/rules/no-noninteractive-element-interactions.md)               | Disallow non-interactive elements being assigned mouse or keyboard event listeners.                                                 | ☑️ 🔒 |       |     |
| [no-noninteractive-element-to-interactive-role](docs/rules/no-noninteractive-element-to-interactive-role.md) | Disallow non-interactive elements being assigned interactive roles.                                                                 | ☑️ 🔒 |       |     |
| [no-noninteractive-tabindex](docs/rules/no-noninteractive-tabindex.md)                                       | Enforce `tabIndex` only be declared on interactive elements.                                                                        | ☑️ 🔒 |       |     |
