/**
 * @file Enforce heading (h1, h2, etc) elements contain accessible content.
 * @author Ethan Cohen
 */
...
export default {
  meta: {
    docs: {
      url: 'https://github.com/es-tooling/eslint-plugin-jsx-a11y-x/tree/HEAD/docs/rules/heading-has-content.md',
      description:
