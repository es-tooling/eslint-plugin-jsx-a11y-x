/**
 * @file Enforce usage of onBlur over onChange for accessibility.
 * @author Ethan Cohen
 */
...
export default {
  meta: {
    docs: {
      url: 'https://github.com/es-tooling/eslint-plugin-jsx-a11y-x/tree/HEAD/docs/rules/no-onchange.md',
      description:
