/**
 * @file Enforce that elements with ARIA roles must have all required attributes
 *   for that role.
 * @author Ethan Cohen
 */
...
export default {
  meta: {
    docs: {
      url: 'https://github.com/es-tooling/eslint-plugin-jsx-a11y-x/tree/HEAD/docs/rules/role-has-required-aria-props.md',
      description:
