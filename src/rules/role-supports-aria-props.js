/**
 * @file Enforce that elements with explicit or implicit roles defined contain
...
export default {
  meta: {
    docs: {
      url: 'https://github.com/es-tooling/eslint-plugin-jsx-a11y-x/tree/HEAD/docs/rules/role-supports-aria-props.md',
      description:
